...
import ru.dotsenko.crud.firstCrud.dao.BookDAO;
...
@Autowired
    ...
    //Показать книги - работает
    @GetMapping()
    public String index(Model model) {
        model.addAttribute("book", bookDAO.index());
        return "books/index";
    }
    //Показать выбранную книгу - не работает!!
    @GetMapping("/{id}")
    ...
    //Редактировать книгу - не работает!!
    @GetMapping("/{id}/edit")
